...
def settingConfiguration(config:configparser.ConfigParser):
    ...
    return path, autoremove, recursive
...
if __name__ == '__main__':
    ...
    try:
        path, autoremove, recursive = settingConfiguration(config)
    except KeyError:
...
#!Tengo que hacer testing recursivos
#!Tengo que hacer testing de autoremove
